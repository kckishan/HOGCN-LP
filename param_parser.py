...
def parameter_parser():
    ...
    parser.add_argument('--network_type', default="PPI",
    ...
    parser.add_argument("--cut-off", type=float, default=0.074,
    ...
    parser.add_argument("--order", type=int, default=4,
                        help="Order of neighborhood. Default is 2.")
    ...
    parser.set_defaults(budget=100)
